...
function singlePlayer(json, slug, html5 = true) {
    var setup = {
        ...
        plugins: {"nuevo": {title: "Nuevo plugin for VideoJs Player", chapterMarkers: false}}
    };
    ...
    var chapters = false;
    // Chapters - только для mp4 файлов
    if (json['chapters']){
        var chapters_file = src.substr(0, src.lastIndexOf(".")) + ".vtt";
        chapters = {kind:"chapters", src:chapters_file, srclang:"ru"};
    }
